...
export default class appointments extends Component {
  componentDidMount() {
    $(document).ready(function() {
      ...
      // className colors: default(transparent), important(red), chill(pink), success(green), info(blue)
      ...
      var calendar = $("#calendar").fullCalendar({
        ...
        editable: true,
        firstDay: 6, //  1(Monday) this can be changed to 0(Sunday)
        selectable: true,
        defaultView: "month",
    ...
    (function($, undefined) {
        ...
        function _fetchEventSource(source, callback) {
          ...
          if (events) {
            if ($.isFunction(events)) {
              pushLoading();
              events(cloneDate(rangeStart), cloneDate(rangeEnd), function(
                events
              ) {
                callback(events);
                popLoading();
      ...
      /* jQuery UI (https://github.com/jquery/jquery-ui/blob/master/ui/jquery.ui.datepicker.js)
       *
          ...
          <div className="collapse navbar-collapse" id="navbarText">
            <ul className="navbar-nav mr-auto">
              ...
              <li className="nav-item active">
                <Link to="/appointments" className="nav-link current">
